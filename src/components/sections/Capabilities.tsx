          ...
          {capabilities.cards.map((c, i) => (
            <Reveal key={c.title} delay={i * 0.08}>
              <motion.div
                ...
                className="group flex h-full min-h-[19rem] flex-col rounded-3xl border border-white/10 bg-[#1c2029] p-6 transition-colors duration-300 hover:border-accent-2/40 hover:bg-[#22262f] sm:min-h-[22rem]"
              >
                {/* icon circle(s) */}
